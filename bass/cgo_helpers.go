...
func streamprocC741188F(chandle C.HSTREAM, cbuffer unsafe.Pointer, clength C.DWORD, cuser unsafe.Pointer) C.uint {
	if streamprocC741188FFunc != nil {
		...
		ret, _ := (C.uint)(retc741188f), cgoAllocsUnknown
		return ret
	}
...
func filelenproc69F2A6D6(cuser unsafe.Pointer) C.ulonglong {
	if filelenproc69F2A6D6Func != nil {
		user69f2a6d6 := (unsafe.Pointer)(unsafe.Pointer(cuser))
		ret69f2a6d6 := filelenproc69F2A6D6Func(user69f2a6d6)
		ret, _ := (C.ulonglong)(ret69f2a6d6), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
func filereadproc4D4B6DCA(cbuffer unsafe.Pointer, clength C.DWORD, cuser unsafe.Pointer) C.uint {
	if filereadproc4D4B6DCAFunc != nil {
		...
		ret, _ := (C.uint)(ret4d4b6dca), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
func fileseekproc9820B893(coffset C.QWORD, cuser unsafe.Pointer) C.int {
	if fileseekproc9820B893Func != nil {
		...
		ret, _ := (C.int)(ret9820b893), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
func downloadprocD99FA183(cbuffer unsafe.Pointer, clength C.DWORD, cuser unsafe.Pointer) {
	if downloadprocD99FA183Func != nil {
		...
		buf := unsafe.Slice((*byte)(cbuffer), clength)

		downloadprocD99FA183Func(buf, lengthd99fa183, userd99fa183)
		return
	}
	panic("callback func has not been set (race?)")
}
...
func recordprocF0B593C(chandle C.HRECORD, cbuffer unsafe.Pointer, clength C.DWORD, cuser unsafe.Pointer) C.int {
	if recordprocF0B593CFunc != nil {
		...
		ret, _ := (C.int)(retf0b593c), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
func encoderprocCA4A3C53(chandle C.HENCODE, cchannel C.DWORD, cbuffer unsafe.Pointer, clength C.DWORD, cmaxout C.DWORD, cuser unsafe.Pointer) C.uint {
	if encoderprocCA4A3C53Func != nil {
		...
		ret, _ := (C.uint)(retca4a3c53), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}
...
func encodeclientproc541D704(chandle C.HENCODE, cconnect C.BOOL, cclient *C.char, cheaders *C.char, cuser unsafe.Pointer) C.int {
	if encodeclientproc541D704Func != nil {
		...
		ret, _ := (C.int)(ret541d704), cgoAllocsUnknown
		return ret
	}
	panic("callback func has not been set (race?)")
}
